...
def queryBase(request):
    ...
    #9. Tutti gli articoli pubblicati in un intervallo di data
    ...
    #14. Tutti gli articoli con un certo numero minimo di visualizazioni:
    articoli_mimime_visualizzazioni = Articolo.objects.filter(visualizzazioni__gte=100)
    ...
    #poi dare i comandi makemigrations e migrate per appliare le modifiche al database
    ...
    in base al campo visualizzazioni nel modello Articolo. La notazione articoli_visualizzazioni indica che si sta seguendo
    la relazione inversa dalla classe Giornalista alla classe Articolo attraverso
    ...
    In questo caso, ciò è utile perché un giornalista potrebbe essere associato a più articoli che soddisfano il criterio,
    ...
    #Per mettere in OR le condizioni utilizzo operatore Q
    ...
    #21 Esclude gli articoli che soddisfano la condizione
